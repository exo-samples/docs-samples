...
public class UpdateProfilePlugin extends BaseNotificationPlugin {
  ...
  public final static ArgumentLiteral<String>  USER_FULL_NAME   = new ArgumentLiteral<>(String.class, "userFullName");

  public final static ArgumentLiteral<String>  USER_PROFILE_URL = new ArgumentLiteral<>(String.class, "userProfileUrl");
  ...
  protected NotificationInfo makeNotification(NotificationContext ctx) {
    ...
    return NotificationInfo.instance()
                           ...
                           .setTitle(updatedIdentity.getProfile().getFullName() + " updated his/her profile information.<br/>")
                           .with(USER_FULL_NAME.getKey(), updatedIdentity.getProfile().getFullName())
                           .with(USER_PROFILE_URL.getKey(), updatedIdentity.getProfile().getUrl())
                           .key(getId());
  }
}
